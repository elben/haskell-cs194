...
Despite their scary name, there’s nothing all that frightening – or even
all that special – about monads. The concept of monad started its life
as an abstract bit of mathematics, and it so happened that functional
programmers stumbled upon it as a useful programming construct. But it
*is* a useful programming construct!

A monad is handy whenever a programmer wants to sequence actions, and
the details of the monad says exactly how the actions should be
sequenced. A monad may also store some information that can be read from
and written to while performing actions.
...
comprehension notation for *any* monad. But, I’ve never used one for
anything other than lists.

* * * * *

`Generated 2014-12-04 13:37:47.814655`
